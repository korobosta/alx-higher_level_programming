#!/usr/bin/python3
"""This module contains functions that lists all states with a name starting
    with N (upper N) from a specific database.
"""
import MySQLdb
import sys
...
def query(cur):
    """Performs a "SELECT" query that lists all states with a name starting
        with N
    """
